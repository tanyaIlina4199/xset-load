UC06_New_user_registration()
{
	...
	*/
	...
	web_submit_data("login.pl_2", 
		...
		"Name=password", "Value=game", ENDITEM, 
		"Name=passwordConfirm", "Value=game", ENDITEM, 
		"Name=firstName", "Value=gaga", ENDITEM, 
		"Name=lastName", "Value=game", ENDITEM, 
	...
	web_url("privacy.min.txt", 
		"URL=https://cdn.jsdelivr.net/gh/uBlockOrigin/uAssetsCDN@main/filters/privacy.min.txt", 
		"Resource=1", 
